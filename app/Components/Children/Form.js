...
var Form = React.createClass({
	...
	handleChange: function(event){
    	...
    	//this.setState "more likely reset the value whenever you typed the value"
    	//taget: element is going to change
    	//id equeals to element id, 
	...
	handleClick: function(){
		...
		this.props.setTerm(this.state.term); //current state of current box.
