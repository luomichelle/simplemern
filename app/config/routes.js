...
module.exports = (
	...
	<Route path='/' component={Main}>   
		...
		{/* If user selects Child1 then show the appropriate component, jsx mode is on when you have {}*/}
		<Route path='Child1' component={Child1} >

			{/*Child1 has its own Grandchildren options and it make a / for you from main to child to grandchild1*/}
